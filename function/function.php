...
function banner2($api){
    //============> GET VISITOR CHECKING
    $total = total_visitor_checking($api);
    //============> COLLOR
    $BL   = collorLine("BL");
    $RD   = collorLine("RD");
    $GR   = collorLine("GR");
...
$WH       ===================================================================$DEF
                    ...
                    |$YL GATEWAY$DEF :$WH STRIPE CHARGER$DEF              |
$WH       ===================================================================$DEF
...
function total_visitor_checking($api){
    $visitor = array_unique(explode("\n", str_replace("\r", "", file_get_contents("$api/checker/stripe-charger/total_visitor_checking.txt"))));
    $count = count($visitor);
    $total = $count - 1;
